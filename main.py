...
def main() -> None:
    ...
    parser.add_argument("--max-retries-per-stage", type=int, default=1, help="每个阶段允许重试次数")
    parser.add_argument("--research-top-k", type=int, default=8, help="ResearchAgent 搜索条目数")
